...
# Silicon Valley Itinerary Planner

This interactive demo showcases a real-time, voice-driven conversational experience using the Gemini API, grounded with data from Google Maps and visualized on a Photorealistic 3D Map. It's wrapped in a sleek "Silicon Valley" theme and features a gamified badge system to reward user interaction.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fgoogle-gemini%2Fcreative-apps%2Ftree%2Fmain%2Fproject-map-itinerary&env=GEMINI_API_KEY&envDescription=Your%20Google%20Gemini%20API%20Key&envLink=https%3A%2F%2Faistudio.google.com%2Fapp%2Fapikey)
...
2.  You will be prompted to create a new Git repository from this template.
3.  Enter your Gemini API Key in the `GEMINI_API_KEY` environment variable field.
