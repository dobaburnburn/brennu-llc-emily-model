  ...
  return (
    <div className="popup-overlay">
      <div className="popup-content">
        <h2>Welcome to the Silicon Valley Itinerary Planner</h2>
...
Plan a day trip using natural language and earn badges as you explore how Gemini leverages Google Maps to deliver accurate, up-to-the-minute information.
          </p>
          <p>To get started:</p>
          <ol>
            <li>
            ...
            <li>
              ...
              <div><strong>Speak naturally &nbsp;</strong>to plan your trip and earn your first badge! Try saying,
            ...
            <li>
              ...
              voice and see your unlocked badges.</div>
            </li>
          </ol>
        </div>
